...
data_dir <- "Code/Prevalence/Bovine BCT and PCR/Analysis_NGA_all_PCR/Cattle_at_risk/"
...
focused_output_file <- "Code/Prevalence/Bovine BCT and PCR/Analysis_NGA_all_PCR/Nigeria_cattle_uncertainty.csv"
