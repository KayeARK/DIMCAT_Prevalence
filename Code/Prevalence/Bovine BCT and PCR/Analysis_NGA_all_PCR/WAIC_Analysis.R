...
print(p1)
ggsave(paste0("Code/Prevalence/Bovine BCT and PCR/Analysis_", country_code, "_all_PCR/WAIC_Aggregate_Importance_", country_code, ".png"), 
...
print(p2)
ggsave(paste0("Code/Prevalence/Bovine BCT and PCR/Analysis_", country_code, "_all_PCR/WAIC_Mean_Importance_", country_code, ".png"), 
...
print(p3)
ggsave(paste0("Code/Prevalence/Bovine BCT and PCR/Analysis_", country_code, "_all_PCR/WAIC_Heatmap_", country_code, ".png"), 
...
print(p4)
ggsave(paste0("Code/Prevalence/Bovine BCT and PCR/Analysis_", country_code, "_all_PCR/WAIC_Distribution_", country_code, ".png"), 
...
print(p5)
ggsave(paste0("Code/Prevalence/Bovine BCT and PCR/Analysis_", country_code, "_all_PCR/WAIC_Ranking_Consistency_", country_code, ".png"), 
...
print(p6)
ggsave(paste0("Code/Prevalence/Bovine BCT and PCR/Analysis_", country_code, "_all_PCR/WAIC_Radar_Plot_", country_code, ".png"), 
