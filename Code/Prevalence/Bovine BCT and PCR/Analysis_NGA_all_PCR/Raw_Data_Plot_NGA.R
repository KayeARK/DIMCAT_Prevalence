...
p <- ggplot() +
  ...
  labs(
    ...
    subtitle = paste0("N = ", nrow(bovine_nigeria), " observations | ", 
...
# Save the map plot
output_file <- "Code/Prevalence/Bovine BCT and PCR/Analysis_NGA_all_PCR/Raw_AAT_Data_Nigeria.png"
...
# Save histogram
hist_file <- "Code/Prevalence/Bovine BCT and PCR/Analysis_NGA_all_PCR/AAT_Prevalence_Histogram_Nigeria.png"
