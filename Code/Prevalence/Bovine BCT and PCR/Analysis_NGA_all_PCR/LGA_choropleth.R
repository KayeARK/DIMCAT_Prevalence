...
projections_dir <- "Code/Prevalence/Bovine BCT and PCR/Projections_NGA_all_PCR/"
...
p_mean <- create_choropleth(lga_prevalence_mean, "(mean)", add_bovine_data = FALSE, show_uncertainty = FALSE, add_inset = TRUE)
...
create_combined_plot <- function(lga_data, estimate_name) {
  ...
  p_hist <- ggplot(lga_data, aes(x = lga_prevalence, fill = after_stat(x))) +
    ...
    labs(
      title = paste("Distribution of", estimate_name, "prevalence by LGA"),
      x = ""
    )
...
ggsave("Code/Prevalence/Bovine BCT and PCR/Analysis_NGA_all_PCR/lga_choropleth_mean.pdf", plot = p_mean, width = 12, height = 10)
ggsave("Code/Prevalence/Bovine BCT and PCR/Analysis_NGA_all_PCR/lga_choropleth_lower.pdf", plot = p_lower, width = 12, height = 10)
ggsave("Code/Prevalence/Bovine BCT and PCR/Analysis_NGA_all_PCR/lga_choropleth_upper.pdf", plot = p_upper, width = 12, height = 10)

# Save combined plots (histogram + boxplot for each estimate type) - more compact dimensions
ggsave("Code/Prevalence/Bovine BCT and PCR/Analysis_NGA_all_PCR/lga_mean_analysis.pdf", plot = p_mean_combined, width = 10, height = 6)
ggsave("Code/Prevalence/Bovine BCT and PCR/Analysis_NGA_all_PCR/lga_lower_analysis.pdf", plot = p_lower_combined, width = 10, height = 6)
ggsave("Code/Prevalence/Bovine BCT and PCR/Analysis_NGA_all_PCR/lga_upper_analysis.pdf", plot = p_upper_combined, width = 10, height = 6)
