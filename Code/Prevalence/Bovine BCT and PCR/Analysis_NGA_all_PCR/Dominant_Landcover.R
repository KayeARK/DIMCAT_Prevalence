...
ggsave(paste0("Code/Prevalence/Bovine BCT and PCR/Analysis_NGA_all_PCR/Covariate_maps/Dominant_Landcover_", country_code, ".pdf"), 
       plot = p, width = 12, height = 8)

cat("\nPlot saved as Dominant_Landcover_", country_code, ".png and .pdf in Analysis_NGA_all_PCR folder\n")
...
ggsave(paste0("Code/Prevalence/Bovine BCT and PCR/Analysis_NGA_all_PCR/Covariate_maps/Elevation_", country_code, ".pdf"), plot = p_elv, width = 12, height = 8)
...
ggsave(paste0("Code/Prevalence/Bovine BCT and PCR/Analysis_NGA_all_PCR/Covariate_maps/Precipitation_", country_code, ".pdf"), plot = p_prec, width = 12, height = 8)
...
ggsave(paste0("Code/Prevalence/Bovine BCT and PCR/Analysis_NGA_all_PCR/Covariate_maps/Temperature_", country_code, ".pdf"), plot = p_tavg, width = 12, height = 8)
...
ggsave(paste0("Code/Prevalence/Bovine BCT and PCR/Analysis_NGA_all_PCR/Covariate_maps/PopulationDensity_", country_code, ".png"), 
       plot = p_pop, width = 12, height = 8, dpi = 600, type = "cairo-png")
ggsave(paste0("Code/Prevalence/Bovine BCT and PCR/Analysis_NGA_all_PCR/Covariate_maps/PopulationDensity_", country_code, ".tiff"), 
       plot = p_pop, width = 12, height = 8, dpi = 600, compression = "none")
ggsave(paste0("Code/Prevalence/Bovine BCT and PCR/Analysis_NGA_all_PCR/Covariate_maps/PopulationDensity_", country_code, ".pdf"), 
...
ggsave(paste0("Code/Prevalence/Bovine BCT and PCR/Analysis_NGA_all_PCR/Covariate_maps/HumanFootprint_", country_code, ".pdf"), plot = p_hfp, width = 12, height = 8)
...
ggsave(paste0("Code/Prevalence/Bovine BCT and PCR/Analysis_NGA_all_PCR/Covariate_maps/CattleDensity_", country_code, ".png"), 
       plot = p_cattle, width = 12, height = 8, dpi = 600, type = "cairo-png")
ggsave(paste0("Code/Prevalence/Bovine BCT and PCR/Analysis_NGA_all_PCR/Covariate_maps/CattleDensity_", country_code, ".tiff"), 
       plot = p_cattle, width = 12, height = 8, dpi = 600, compression = "none")
ggsave(paste0("Code/Prevalence/Bovine BCT and PCR/Analysis_NGA_all_PCR/Covariate_maps/CattleDensity_", country_code, ".pdf"), 
...
# Save with high DPI for sharp rasters - multiple formats for best quality
ggsave(paste0("Code/Prevalence/Bovine BCT and PCR/Analysis_NGA_all_PCR/Covariate_maps/TsetsePresence_", country_code, ".png"), 
       plot = p_tsetse, width = 12, height = 8, dpi = 600, type = "cairo-png")
ggsave(paste0("Code/Prevalence/Bovine BCT and PCR/Analysis_NGA_all_PCR/Covariate_maps/TsetsePresence_", country_code, ".tiff"), 
       plot = p_tsetse, width = 12, height = 8, dpi = 600, compression = "none")
ggsave(paste0("Code/Prevalence/Bovine BCT and PCR/Analysis_NGA_all_PCR/Covariate_maps/TsetsePresence_", country_code, ".pdf"), 
       plot = p_tsetse, width = 12, height = 8, device = "pdf", dpi = 600, 
       useDingbats = FALSE, compress = FALSE)

cat("\n=== All covariate visualizations completed for", country_name, "===\n")
cat("Files saved to Analysis_NGA_all_PCR/ folder\n")
