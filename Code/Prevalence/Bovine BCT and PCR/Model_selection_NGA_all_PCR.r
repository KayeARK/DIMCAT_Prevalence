...
data_path <- paste0("Code/TestSensSpec/adjusted_cases_all_sites_all_PCR.csv")
...
write.csv(data.frame(covariates,waic_increase), paste0("Code/Prevalence/Bovine BCT and PCR/WAIC_increase_NGA_all_PCR/WAIC_increase_model_",iteration-7,".csv"), row.names = FALSE)
...
write.csv(data.frame(covariates), paste0("Code/Prevalence/Bovine BCT and PCR/Covariates_NGA_all_PCR/Covariates_model_",iteration-7,".csv"), row.names = FALSE)
#write dpm to a csv labelled with iteration
write.csv(dpm, paste0("Code/Prevalence/Bovine BCT and PCR/Projections_NGA_all_PCR/Projections_model_",iteration-7,".csv"), row.names = FALSE)
}
