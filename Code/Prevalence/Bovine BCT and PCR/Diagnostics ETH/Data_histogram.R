...
p_geo <- plot_histogram(
  ...
  title = "Geostatistical Ethiopia data"
)
...
p_scatter <- ggplot(
  ...
  labs(
    title = "Raw vs adjusted prevalence in Ethiopia",
    x = "Raw prevalence",
...
ggsave(
  "Code/Prevalence/Bovine BCT and PCR/Diagnostics ETH/Figure_Raw_Histogram.png",
  p_raw,
  width = 7,
  height = 5,
  dpi = 300
...
ggsave(
  "Code/Prevalence/Bovine BCT and PCR/Diagnostics ETH/Figure_Adjusted_Histogram.png",
  p_adjusted,
  width = 7,
  height = 5,
  dpi = 300
...
ggsave(
  "Code/Prevalence/Bovine BCT and PCR/Diagnostics ETH/Figure_Geostatistical_Histogram.png",
  p_geo,
  width = 7,
  height = 5,
  dpi = 300
...
ggsave(
  "Code/Prevalence/Bovine BCT and PCR/Diagnostics ETH/Figure_Raw_vs_Adjusted.png",
  p_scatter,
  width = 7,
  height = 5,
  dpi = 300
