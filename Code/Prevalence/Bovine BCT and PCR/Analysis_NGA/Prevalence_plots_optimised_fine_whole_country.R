...
tsetse_multiplier <- ifelse(tsetse_mask, 1, 1)  # 1 where tsetse present, 0 where absent
...
if (!is.null(results_df) && nrow(results_df) > 0) {
  ...
  write.csv(dpm_combined_state, paste0("Code/Prevalence/Bovine BCT and PCR/Analysis_NGA/Cattle_at_risk_fine_whole_country/Projections_model_", i, ".csv"), row.names = FALSE)
