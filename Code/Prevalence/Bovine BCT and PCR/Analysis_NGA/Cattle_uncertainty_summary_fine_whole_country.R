...
data_dir <- "Code/Prevalence/Bovine BCT and PCR/Analysis_NGA/Cattle_at_risk_fine_whole_country/"
...
focused_output_file <- "Code/Prevalence/Bovine BCT and PCR/Analysis_NGA/Nigeria_cattle_uncertainty_fine_whole_country.csv"
