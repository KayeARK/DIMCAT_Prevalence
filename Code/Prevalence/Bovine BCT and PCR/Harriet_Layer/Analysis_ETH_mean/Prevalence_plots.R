...
# Check if coordinates need swapping for Ethiopia (Lat: 3-15°N, Lon: 33-48°E) - Mean
...
# Swap longitude and latitude if they appear to be reversed - Mean
if (!lat_in_range || !lon_in_range) {
  cat("Coordinates appear swapped for Ethiopia model", i, ", correcting...\n")
