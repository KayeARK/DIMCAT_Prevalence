...
#     legend.box = "vertical")
# ggsave(paste0("Code/Prevalence/Bovine BCT and PCR/Analysis_NGA/Prevalence_plots/Projections_model_",i,".png"),width = 12, height = 8)

write.csv(dpm_combined_state,paste0("Code/Prevalence/Bovine BCT and PCR/Analysis_NGA/Cattle_at_risk/Projections_model_",i,".csv"), row.names=FALSE)
