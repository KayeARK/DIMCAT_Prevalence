...
projections_dir <- "Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/Projections_ETH_max/"
...
# Save all plots to Analysis_ETH_max directory
ggsave("Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/Analysis_ETH_max/eth_choropleth_mean.pdf", plot = p_mean, width = 12, height = 10)
ggsave("Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/Analysis_ETH_max/eth_choropleth_lower.pdf", plot = p_lower, width = 12, height = 10)
ggsave("Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/Analysis_ETH_max/eth_choropleth_upper.pdf", plot = p_upper, width = 12, height = 10)

# Save combined plots (histogram + boxplot for each estimate type) - more compact dimensions
ggsave("Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/Analysis_ETH_max/eth_mean_analysis.pdf", plot = p_mean_combined, width = 10, height = 6)
ggsave("Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/Analysis_ETH_max/eth_lower_analysis.pdf", plot = p_lower_combined, width = 10, height = 6)
ggsave("Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/Analysis_ETH_max/eth_upper_analysis.pdf", plot = p_upper_combined, width = 10, height = 6)
