...
n_datasets <- 200
sample_file <- "Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/Projections_ETH_max/Projections_model_1.csv"
...
dpm <- read.csv(paste0("Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/Projections_ETH_max/Projections_model_",i,".csv"))
...
ggsave("Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/Analysis_ETH_max/region_rel_between_choropleth.pdf", plot = p_rel_between, width = 12, height = 10)
ggsave("Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/Analysis_ETH_max/region_rel_within_choropleth.pdf", plot = p_rel_within, width = 12, height = 10)
ggsave("Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/Analysis_ETH_max/region_between_var_choropleth.pdf", plot = p_between_var, width = 12, height = 10)

# Save combined plots (histogram + boxplot for each uncertainty measure)
ggsave("Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/Analysis_ETH_max/region_rel_between_analysis.pdf", plot = p_rel_between_combined, width = 10, height = 6)
ggsave("Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/Analysis_ETH_max/region_rel_within_analysis.pdf", plot = p_rel_within_combined, width = 10, height = 6)
ggsave("Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/Analysis_ETH_max/region_between_var_analysis.pdf", plot = p_between_var_combined, width = 10, height = 6)
...
ggsave("Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/Analysis_ETH_max/Relative_uncertainty_between.png",width = 12, height = 8)
...
ggplot(dpm_var, aes(x = rel_between)) +
  ...
  labs(
       ...
       y = "Frequency")
ggsave("Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/Analysis_ETH_max/Relative_uncertainty_between_histogram.png",width = 8, height = 6)
