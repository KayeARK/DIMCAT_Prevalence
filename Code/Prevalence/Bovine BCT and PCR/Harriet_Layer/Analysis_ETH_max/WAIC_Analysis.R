...
waic_files <- list.files(paste0("Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/WAIC_increase_", country_code, "_max"), 
...
print(p1)
ggsave(paste0("Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/Analysis_", country_code, "_max/WAIC_Aggregate_Importance_", country_code, ".png"), 
...
print(p2)
ggsave(paste0("Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/Analysis_", country_code, "_max/WAIC_Mean_Importance_", country_code, ".png"), 
...
print(p3)
ggsave(paste0("Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/Analysis_", country_code, "_max/WAIC_Heatmap_", country_code, ".png"), 
...
print(p4)
ggsave(paste0("Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/Analysis_", country_code, "_max/WAIC_Distribution_", country_code, ".png"), 
...
print(p5)
ggsave(paste0("Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/Analysis_", country_code, "_max/WAIC_Ranking_Consistency_", country_code, ".png"), 
...
print(p6)
ggsave(paste0("Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/Analysis_", country_code, "_max/WAIC_Radar_Plot_", country_code, ".png"), 
