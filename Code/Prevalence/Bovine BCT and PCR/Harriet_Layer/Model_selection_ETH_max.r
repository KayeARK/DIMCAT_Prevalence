...
for (iteration in (1+7):(200+7)){
  ...
  write.csv(data.frame(covariates,waic_increase), paste0("Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/WAIC_increase_ETH_max/WAIC_increase_model_",iteration-7,".csv"), row.names = FALSE)
  ...
  dir.create("Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/Covariates_ETH_max", showWarnings = FALSE, recursive = TRUE)
  dir.create("Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/Projections_ETH_max", showWarnings = FALSE, recursive = TRUE)

  # Write covariates and projections to CSV files
  write.csv(data.frame(covariates), 
           paste0("Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/Covariates_ETH_max/Covariates_model_", iteration-7, ".csv"), 
           row.names = FALSE)
  
  write.csv(dpm, 
           paste0("Code/Prevalence/Bovine BCT and PCR/Harriet_Layer/Projections_ETH_max/Projections_model_", iteration-7, ".csv"), 
           row.names = FALSE)
