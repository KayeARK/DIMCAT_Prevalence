...
data_dir <- "Code/Prevalence/Bovine BCT and PCR/Analysis_ETH/Cattle_at_risk_fine/"
...
focused_output_file <- "Code/Prevalence/Bovine BCT and PCR/Analysis_ETH/Ethiopia_cattle_uncertainty_fine.csv"
