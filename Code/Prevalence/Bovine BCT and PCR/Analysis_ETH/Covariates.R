...
covariates_all<-c("elevation","precipitation","human_fp","pop_den","tree","grassland",
...
p <- ggplot(df, aes(x=Covariate, y=Count)) + 
  ...
  ylim(0, 200)
ggsave("Code/Prevalence/Bovine BCT and PCR/Analysis_ETH/Covariate_Selection_Frequency.png", plot = p, width = 10, height = 6)
...
ggsave("Code/Prevalence/Bovine BCT and PCR/Analysis_ETH/Covariate_Importance_Percentage.png", plot = p2, width = 10, height = 8)
...
ggsave("Code/Prevalence/Bovine BCT and PCR/Analysis_ETH/Covariate_Cooccurrence_Heatmap.png", plot = p3, width = 12, height = 10)
...
ggsave("Code/Prevalence/Bovine BCT and PCR/Analysis_ETH/Covariate_Selection_Uncertainty.png", plot = p4, width = 10, height = 8)
...
ggsave("Code/Prevalence/Bovine BCT and PCR/Analysis_ETH/Covariate_Radial_Plot.png", plot = p5, width = 10, height = 10)
...
ggsave("Code/Prevalence/Bovine BCT and PCR/Analysis_ETH/Model_Complexity_Distribution.png", plot = p6, width = 10, height = 6)
...
ggsave("Code/Prevalence/Bovine BCT and PCR/Analysis_ETH/Covariate_Category_Importance.png", plot = p7, width = 10, height = 6)
