...
if (!is.null(results_df) && nrow(results_df) > 0) {
  ...
  # Write output
  write.csv(dpm_combined_region, paste0("Code/Prevalence/Bovine BCT and PCR/Analysis_ETH/Cattle_at_risk_fine_whole_country/Projections_model_", i, ".csv"), row.names = FALSE)
