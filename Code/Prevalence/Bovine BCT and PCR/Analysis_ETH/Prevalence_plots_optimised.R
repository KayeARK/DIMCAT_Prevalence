...
output_dir <- "Code/Prevalence/Bovine BCT and PCR/Analysis_ETH/Cattle_at_risk/"
...
# Perform spatial join with Ethiopian regions
join_result <- st_join(coords_mean_country, country_sf, join = st_within)
region_assignments <- join_result$NAME_1
