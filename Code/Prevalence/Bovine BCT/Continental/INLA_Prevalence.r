...
#save
ggsave(paste0("Code/Prevalence/Bovine BCT/Results/",countries_to_infer,"/",countries_to_infer,"Prevalence_vs_Mode.png"),width = 8, height = 6)
...
ggplot(dpm_s, aes(x = prevalence, y = modes)) +
  ...
  xlim(0, 0.83) +
  ylim(0, 0.32)
ggsave(paste0("Code/Prevalence/Bovine BCT/Results/",countries_to_infer,"/",countries_to_infer,"Prevalence_vs_Mode_ss",s,".png"),width = 8, height = 6)
}
