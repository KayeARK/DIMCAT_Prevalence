...
#order waic_increase in descending order and the same ordering for covariates
order_index <- order(waic_increase, decreasing = TRUE)
covariates <- covariates[order_index]
waic_increase <- waic_increase[order_index]

#save covariates and waic_increase
covariates <- data.frame(covariates = covariates, waic_increase = waic_increase)
