...
ggsave(paste0("Code/Prevalence/Bovine BCT/Data degradation/Results/",countries_to_infer,"Predictions.png"),width = 12, height = 8)

write.csv(waic_refs, paste0("Code/Prevalence/Bovine BCT/Data degradation/Results/",countries_to_infer,"/",countries_to_infer,"WAICs_south.csv"), row.names = FALSE)
write.csv(covariates, paste0("Code/Prevalence/Bovine BCT/Data degradation/Results/",countries_to_infer,"/",countries_to_infer,"Covariates_south.csv"), row.names = FALSE)
