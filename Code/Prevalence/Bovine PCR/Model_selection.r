...
"shrub","cropland","built","bare","water","wetland","mangrove","moss","cattle","tavg","tmax")
...
write.csv(waic_refs, paste0("Code/Prevalence/Bovine BCT/Results/",countries_to_infer,"WAICs.csv"), row.names = FALSE)
write.csv(covariates, paste0("Code/Prevalence/Bovine BCT/Results/",countries_to_infer,"Covariates.csv"), row.names = FALSE)
