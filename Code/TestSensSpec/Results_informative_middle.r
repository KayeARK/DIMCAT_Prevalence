...
fit<-readRDS("Code/TestSensSpec/latent_class_fit_middle.rds")
...
y_vals <- dnorm(qlogis(x_vals), mean = 0, sd = 0.5) / (x_vals * (1 - x_vals))
...
ggsave("Code/TestSensSpec/sensitivity_density_middle.pdf", plot = p1, width = 8, height = 6)
...
print(p1)
ggsave("Code/TestSensSpec/specificity_density_middle.pdf", plot = p1, width = 8, height = 6)
...
ggsave("Code/TestSensSpec/mcmc_trace_middle.pdf", width = 8, height = 6)
