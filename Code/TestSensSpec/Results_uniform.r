...
fit<-readRDS("Code/TestSensSpec/latent_class_fit_uniform.rds")
...
y_vals <- dnorm(qlogis(x_vals), mean = 0, sd = 1.8) / (x_vals * (1 - x_vals))
...
ggsave("Code/TestSensSpec/sensitivity_density_uniform.pdf", plot = p1, width = 8, height = 6)
...
print(p1)
ggsave("Code/TestSensSpec/specificity_density_uniform.pdf", plot = p1, width = 8, height = 6)
...
ggsave("Code/TestSensSpec/mcmc_trace_uniform.pdf", width = 8, height = 6)
