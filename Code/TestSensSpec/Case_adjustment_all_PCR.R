...
label_HCT <- rep("PCR", length(positive_HCT))
...
write.csv(adjusted_prevalence_df, "Code/TestSensSpec/adjusted_prevalence_all_sites_all_PCR.csv", row.names = TRUE)
...
write.csv(adjusted_cases_df, "Code/TestSensSpec/adjusted_cases_all_sites_all_PCR.csv", row.names = TRUE)
