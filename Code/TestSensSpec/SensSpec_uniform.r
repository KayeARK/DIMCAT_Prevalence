...
model {
  ...
  mu_logit_Se_pcr ~ normal(0, 1.8);  // centers Se_pcr ~ 0.5
  mu_logit_Sp_pcr ~ normal(0, 1.8);  // centers Sp_pcr ~ 0.5
  mu_logit_Se_hct ~ normal(0, 1.8); // centers Se_hct ~ 0.5
  mu_logit_Sp_hct ~ normal(0, 1.8); // centers Sp_hct ~ 0.5
...
# Save fit for later
saveRDS(fit, file = "Code/TestSensSpec/latent_class_fit_uniform.rds")
message("Fit saved to latent_class_fit_uniform.rds")
