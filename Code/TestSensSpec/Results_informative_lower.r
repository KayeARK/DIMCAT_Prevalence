...
fit<-readRDS("Code/TestSensSpec/latent_class_fit_lower.rds")
...
ggsave("Code/TestSensSpec/sensitivity_density_lower.pdf", plot = p1, width = 8, height = 6)
...
print(p1)
ggsave("Code/TestSensSpec/specificity_density_lower.pdf", plot = p1, width = 8, height = 6)
...
ggsave("Code/TestSensSpec/mcmc_trace_lower.pdf", width = 8, height = 6)
