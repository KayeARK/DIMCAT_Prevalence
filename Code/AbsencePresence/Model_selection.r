...
"shrub","cropland","built","bare","water","wetland","mangrove","moss","cattle","buffalo","goat","horse",
"pig","sheep")
...
write.csv(waic_refs, paste0("Code/AbsencePresence/Results/",trypanosome,"/",countries_to_infer,"WAICs.csv"), row.names = FALSE)
write.csv(covariates, paste0("Code/AbsencePresence/Results/",trypanosome,"/",countries_to_infer,"Covariates.csv"), row.names = FALSE)
