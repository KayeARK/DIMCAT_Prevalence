...
#if data$TPR is positive, set to 1
data$TPR[data$TPR>0] <- 1
presence <- data$TPR
...
covariates<-c("elevation","precipitation","tavg","tmin","tmax","human_fp","pop_den","tree","grassland",
"shrub","cropland","built","bare","water","wetland","mangrove","moss","cattle")
...
ggsave("Code/AbsencePresence/Bovine BCT/Results/Predictions_SpecificCountry.png",width = 12, height = 8)
ggsave("Code/AbsencePresence/Covariance.png",width = 12, height = 8)


write.csv(waic_refs, paste0("Code/AbsencePresence/Bovine BCT/Results/",countries_to_infer,"WAICs.csv"), row.names = FALSE)
write.csv(covariates, paste0("Code/AbsencePresence/Bovine BCT/Results/",countries_to_infer,"Covariates.csv"), row.names = FALSE)
